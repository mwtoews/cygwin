...
struct internal_extra_pe_aouthdr 
{
  ...
  short   MajorImageVersion;	/* user definable field to store version of */
  ...
  bfd_vma SizeOfHeapCommit;	/* commit, don't know what to default it to */
...
#define R_AMD64_PCRQUAD		14 /* Pseudo PC64 relocation - Note: not specified by MS/AMD but need for gas pc-relative 64bit wide relocation generated by ELF.  */
